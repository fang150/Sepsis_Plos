...
%  This notebook is sourced and modified from: https://github.com/matthieukomorowski/AI_Clinician/blob/master/AIClinician_sepsis3_def_160219.m
...
tic
abx=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/abx.csv'));
culture=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/culture.csv'));
microbio=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/microbio.csv'));
demog=(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/demog.csv'));
ce010=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce010000.csv'));
ce1020=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce1000020000.csv'));
ce2030=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce2000030000.csv'));
ce3040=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce3000040000.csv'));
ce4050=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce4000050000.csv'));
ce5060=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce5000060000.csv'));
ce6070=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce6000070000.csv'));
ce7080=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce7000080000.csv'));
ce8090=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce8000090000.csv'));
ce90100=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/ce90000100000.csv'));
labU=[ table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/labs_ce.csv')) ; table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/labs_le.csv'))  ];
MV=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/mechvent.csv'));
inputpreadm=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/preadm_fluid.csv'));
inputMV=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/fluid_mv.csv'));
inputCV=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/luid_cv.csv'));
vasoMV=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/vaso_mv.csv'));
vasoCV=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/vaso_cv.csv'));
UOpreadm=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/preadm_uo.csv'));
UO=table2array(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/data/uo.csv'));
toc


%% ####### Extract Reflabs, Refvitals, sample_and_hold from reference_matrices.mat files
mm = matfile('reference_matrices.mat');
Reflabs=mm.Reflabs ;
Refvitals=mm.Refvitals ;
sample_and_hold=mm.sample_and_hold ;
%% ######
...
fprintf('done fill-in missing ICUSTAY\n')
...
fprintf('done compute derived values\n')
%% ########################################################################
