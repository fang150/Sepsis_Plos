...
%  This notebook is sourced and modified from: https://github.com/matthieukomorowski/AI_Clinician/blob/master/AIClinician_mimic3_dataset_160219.m
...
tic
     save('/Users/username/Desktop/mimic_db/AI_Clinician/data/Data_100219_premorbid_plos_rebut.mat', '-v7.3');
toc



demog2=(readtable('/Users/username/Desktop/mimic_db/AI_Clinician/data/demog2.csv'));
...
reformat2=nan(size(reformat,1),116);  %output array
additionalinfo=nan(size(reformat,1),6);  %output array
h = waitbar(0,'Initializing waitbar...');
...
for i=1:npt
    ...
    icustayid=icustayidlist(i);  %1 to 100000, NOT 200 to 300K!
        ...
        demog2i=find(demog2.icustay_id==icustayid+200000);        
        dem2=[ demog2.subject_id(demog2i),demog2.congestive_heart_failure(demog2i),demog2.cardiac_arrhythmias(demog2i),demog2.valvular_disease(demog2i),demog2.pulmonary_circulation(demog2i),demog2.peripheral_vascular(demog2i),demog2.hypertension(demog2i),demog2.paralysis(demog2i),demog2.other_neurological(demog2i),demog2.chronic_pulmonary(demog2i),demog2.diabetes_uncomplicated(demog2i),demog2.diabetes_complicated(demog2i),demog2.hypothyroidism(demog2i),demog2.renal_failure(demog2i),demog2.liver_disease(demog2i),demog2.peptic_ulcer(demog2i),demog2.aids(demog2i),demog2.lymphoma(demog2i),demog2.metastatic_cancer(demog2i),demog2.solid_tumor(demog2i),demog2.rheumatoid_arthritis(demog2i),demog2.coagulopathy(demog2i),demog2.obesity(demog2i),demog2.weight_loss(demog2i),demog2.fluid_electrolyte(demog2i),demog2.blood_loss_anemia(demog2i),demog2.deficiency_anemias(demog2i),demog2.alcohol_abuse(demog2i),demog2.drug_abuse(demog2i),demog2.psychoses(demog2i),demog2.depression(demog2i)];     
...
tic
     save('/Users/username/Desktop/mimic_db/AI_Clinician/data/Data_110219_premorbid_plos_rebut.mat', '-v7.3');
toc
...
dataheaders = ['bloc','icustayid','charttime','gender','age','elixhauser','re_admission', 'died_in_hosp', 'died_within_48h_of_out_time','mortality_90d','delay_end_of_record_and_discharge_or_death',...
    dataheaders,  'median_dose_vaso','max_dose_vaso','input_total','input_4hourly','output_total','output_4hourly','cumulated_balance','subject_id','congestive_heart_failure','cardiac_arrhythmias','valvular_disease','pulmonary_circulation','peripheral_vascular','hypertension','paralysis','other_neurological','chronic_pulmonary','diabetes_uncomplicated','diabetes_complicated','hypothyroidism','renal_failure','liver_disease','peptic_ulcer','aids','lymphoma','metastatic_cancer','solid_tumor','rheumatoid_arthritis','coagulopathy','obesity','weight_loss','fluid_electrolyte','blood_loss_anemia','deficiency_anemias','alcohol_abuse','drug_abuse','psychoses','depression'];

%myheader = ['icustay_id','subject_id','gender','gender','age','elixhauser','congestive_heart_failure'];
 
%additionalinfo=array2table(additionalinfo);
%additionalinfo.Properties.VariableNames=myheader;
...
dataheaders5 = {'bloc','icustayid','charttime','gender','age','elixhauser','re_admission', 'died_in_hosp', 'died_within_48h_of_out_time','mortality_90d','delay_end_of_record_and_discharge_or_death','SOFA','SIRS',...
    ...
    'BUN','Creatinine','Magnesium','Calcium','Ionised_Ca','CO2_mEq','SGOT','SGPT','Total_bili','Albumin','Hb','WBC_count','Platelets_count','PTT','PT','INR',...
    'Arterial_pH','paO2','paCO2','Arterial_BE','HCO3','Arterial_lactate','mechvent','Shock_Index','PaO2_FiO2',...
    'median_dose_vaso','max_dose_vaso','input_total','input_4hourly','output_total','output_4hourly','cumulated_balance','subject_id','congestive_heart_failure','cardiac_arrhythmias','valvular_disease','pulmonary_circulation','peripheral_vascular','hypertension','paralysis','other_neurological','chronic_pulmonary','diabetes_uncomplicated','diabetes_complicated','hypothyroidism','renal_failure','liver_disease','peptic_ulcer','aids','lymphoma','metastatic_cancer','solid_tumor','rheumatoid_arthritis','coagulopathy','obesity','weight_loss','fluid_electrolyte','blood_loss_anemia','deficiency_anemias','alcohol_abuse','drug_abuse','psychoses','depression'};
...
% Added CHF fix missing values for premorbids, only 132 cases

reformat3t.congestive_heart_failure(isnan(reformat3t.congestive_heart_failure))= 0;
reformat3t.cardiac_arrhythmias(isnan(reformat3t.cardiac_arrhythmias))= 0;
reformat3t.valvular_disease(isnan(reformat3t.valvular_disease))= 0;
reformat3t.pulmonary_circulation(isnan(reformat3t.pulmonary_circulation))= 0;
reformat3t.peripheral_vascular(isnan(reformat3t.peripheral_vascular))= 0;
reformat3t.hypertension(isnan(reformat3t.hypertension))= 0 ;  
reformat3t.paralysis(isnan(reformat3t.paralysis))= 0 ; 
reformat3t.other_neurological(isnan(reformat3t.other_neurological))= 0 ; 
reformat3t.chronic_pulmonary(isnan(reformat3t.chronic_pulmonary))= 0 ; 
reformat3t.diabetes_uncomplicated(isnan(reformat3t.diabetes_uncomplicated))= 0 ; 
reformat3t.diabetes_complicated(isnan(reformat3t.diabetes_complicated))=0 ; 
reformat3t.hypothyroidism(isnan(reformat3t.hypothyroidism))=0 ; 
reformat3t.renal_failure(isnan(reformat3t.renal_failure))=0 ; 
reformat3t.liver_disease(isnan(reformat3t.liver_disease))=0 ; 
reformat3t.peptic_ulcer(isnan(reformat3t.peptic_ulcer))=0 ; 
reformat3t.aids(isnan(reformat3t.aids))=0 ; 
reformat3t.lymphoma(isnan(reformat3t.lymphoma))=0 ; 
reformat3t.metastatic_cancer(isnan(reformat3t.metastatic_cancer))=0 ; 
reformat3t.solid_tumor(isnan(reformat3t.solid_tumor))=0 ; 
reformat3t.rheumatoid_arthritis(isnan(reformat3t.rheumatoid_arthritis))=0 ; 
reformat3t.coagulopathy(isnan(reformat3t.coagulopathy))=0 ; 
reformat3t.obesity(isnan(reformat3t.obesity))=0 ; 
reformat3t.weight_loss(isnan(reformat3t.weight_loss))=0 ; 
reformat3t.fluid_electrolyte(isnan(reformat3t.fluid_electrolyte))=0 ; 
reformat3t.blood_loss_anemia(isnan(reformat3t.blood_loss_anemia))=0 ; 
reformat3t.deficiency_anemias(isnan(reformat3t.deficiency_anemias))=0 ; 
reformat3t.alcohol_abuse(isnan(reformat3t.alcohol_abuse))=0 ; 
reformat3t.drug_abuse(isnan(reformat3t.drug_abuse))=0 ; 
reformat3t.psychoses(isnan(reformat3t.psychoses))=0 ; 
reformat3t.depression(isnan(reformat3t.depression))=0 ; 
...
MIMICtable2 = reformat4t;
%save cohort
writetable(MIMICtable2,'./features/MIMICtable2.csv','Delimiter',',');
